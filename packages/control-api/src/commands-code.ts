// The Code-session commands (0135, the mobile-cloud round), spread into CommandSchema through
// commands-machine.ts — commands.ts sits at its size-ratchet cap, and these are the machine
// host's verbs as much as a client's (handler/codesession.ts says who may write what).
import { z } from 'zod';
import { CODE_APPROVAL_CATEGORIES, CODE_SESSION_MODES, CODE_SESSION_STATES } from '@neuramesh/shared';
