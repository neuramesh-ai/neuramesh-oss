...
3. **[`release.yml`](../.github/workflows/release.yml) builds it:** arm64 (macos-14) + x64 (macos-13), each compiling native modules natively, then **sign (Developer ID, Team <id>) → notarize → staple → publish** to a **draft** release in the public releases repo.
